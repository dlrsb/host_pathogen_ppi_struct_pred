...
#                     help='Path to pdbfile to be scored. Note that this file needs to contain at least two chains. The B-factor column is assumed to contain the plDDT score from AlphaFold.')
