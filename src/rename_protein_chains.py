...
def rename_protein_chains2(pdb_filepath, fasta_filepath):
    parser = PDBParser(QUIET=True)
    io = PDBIO()
    name = os.path.split(pdb_filepath)[-1].split('.')[0]
    structure = parser.get_structure(name, pdb_filepath)
...
if __name__ == '__main__':
    rename_protein_chains2("C:\\Users\\dlrba\\Desktop\\unrelaxed_model_1_multimer_v3_pred_0.pdb",
                           "C:\\Users\\dlrba\\Desktop\\5H5R-1.fasta")